      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-2">
          ...
          >
            ...
            <img class="w-8 h-8 rounded-full" src="../assets/logoRonBlanco.png" alt="user photo" />
          </button>
          <!-- Dropdown menu -->
          <div
          ...
          >
            <div class="px-4 py-3">
              <span class="block text-sm text-gray-900 dark:text-white">Academia Ron</span>
              <span class="block text-sm text-gray-500 truncate dark:text-gray-400"
                >ron@academia.com</span
              >
            </div>
        ...
        >
          <ul
            class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-900 md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
          >
            <li>
              <a
                href="#"
